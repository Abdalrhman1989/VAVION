...
export const translations = {
    en: {
        ...
        subSlogan: 'Elevate your brand with our premium creative services from Jeddah & Madinah to the world.',
        ...
        partners: 'Partners',
        aboutTitle1: 'Creativity Meets',
        aboutTitle2: 'Strategy',
        projects: 'Projects',
        ...
        pricingDesc: 'Choose the perfect solution for your business growth.',
        starterPack: 'Starter',
        starterDesc: 'Perfect for new businesses.',
        proPack: 'Professional',
        proDesc: 'Complete identity & digital presence.',
        enterprisePack: 'Enterprise',
        enterpriseDesc: 'Tailored solutions for large organizations.',
        feature1: 'Logo Design',
        feature2: 'Business Cards',
        feature3: 'Basic Guidelines',
        feature4: 'Social Media Profiles',
        feature5: 'Full Visual Identity',
        feature6: 'Website Development',
        feature7: 'Complete Brand Book',
        feature8: 'Marketing Strategy',
        feature9: 'Priority Support',
        getQuote: 'Get a Quote',
        contactForPrice: 'Contact for Price',
        latestInsights: 'Latest Insights',
        insightsDesc: 'Trends, strategies, and creative inspiration.',
        readMore: 'Read More',
        blog1Title: 'The Future of Digital Branding',
        blog1Desc: 'How AI and personalization are reshaping brand identities in 2026.',
        blog2Title: 'Print is Not Dead',
        blog2Desc: 'Why tactile marketing still matters in a digital-first world.',
        blog3Title: 'Web Design Trends',
        blog3Desc: 'Minimalism, micro-interactions, and dark mode dominance.',
        careersTitle: 'Join the Creative Force',
        careersDesc: 'We are always looking for talented individuals to join our team.',
        openPositions: 'Open Positions',
        applyNow: 'Apply Now',
        graphicDesigner: 'Senior Graphic Designer',
        webDev: 'Frontend Developer',
        fullTime: 'Full Time',
    ...
    ar: {
        ...
        subSlogan: 'ارتقِ بعلامتك التجارية مع خدماتنا الإبداعية المتميزة من جدة والمدينة المنورة إلى العالم.',
        ourServices: 'خدماتنا',
        ...
        partners: 'شركاء',
        aboutTitle1: 'حيث يلتقي الإبداع',
        aboutTitle2: 'بالاستراتيجية',
        projects: 'مشروع',
        clientsCount: 'عميل',
        satisfaction: 'رضا تام',
        inSuccess: 'النجاح',
        clients: 'عملاؤنا',
        ...
        pricingDesc: 'اختر الحل الأمثل لنمو أعمالك.',
        starterPack: 'باقة التأسيس',
        starterDesc: 'مثالية للشركات الناشئة.',
        proPack: 'باقة الاحتراف',
        proDesc: 'هوية كاملة وحضور رقمي قوي.',
        enterprisePack: 'باقة الشركات',
        enterpriseDesc: 'حلول مخصصة للمؤسسات الكبرى.',
        feature1: 'تصميم الشعار',
        feature2: 'كروت شخصية',
        feature3: 'دليل إرشادي أساسي',
        feature4: 'ملفات التواصل الاجتماعي',
        feature5: 'هوية بصرية متكاملة',
        feature6: 'تطوير موقع إلكتروني',
        feature7: 'دليل العلامة التجارية الكامل',
        feature8: 'استراتيجية تسويقية',
        feature9: 'دعم فني ذو أولوية',
        getQuote: 'اطلب عرض سعر',
        contactForPrice: 'تواصل للسعر',
        latestInsights: 'أحدث الرؤى',
        insightsDesc: 'اتجاهات، استراتيجيات، وإلهام إبداعي.',
        readMore: 'اقرأ المزيد',
        blog1Title: 'مستقبل العلامات التجارية الرقمية',
        blog1Desc: 'كيف يعيد الذكاء الاصطناعي والتخصيص تشكيل هويات العلامات التجارية في 2026.',
        blog2Title: 'الطباعة لم تمت',
        blog2Desc: 'لماذا لا يزال التسويق الملموس مهماً في عالم رقمي.',
        blog3Title: 'اتجاهات تصميم الويب',
        blog3Desc: 'البساطة، التفاعلات الدقيقة، وسيادة الوضع الليلي.',
        careersTitle: 'انضم إلى قوتنا الإبداعية',
        careersDesc: 'نبحث دائماً عن أفراد موهوبين للانضمام إلى فريقنا.',
        openPositions: 'الوظائف المتاحة',
        applyNow: 'قدم الآن',
        graphicDesigner: 'مصمم جرافيك أول',
        webDev: 'مطور واجهات أمامية',
        fullTime: 'دوام كامل',
        remote: 'عمل عن بعد'
    }
};
